...
<head>
  ...
  <!-- Site Title -->
  <title>Dr. Azad Sexologist Clinic | Low Libido</title>
...
<body>
  ...
  <section class="cs_page_heading cs_bg_filed cs_center" data-src="assets/img/page_heading_bg.jpg">
    <div class="container">
      <h1 class="cs_page_title">Low Libido</h1>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href='index.html'>Home</a></li>
        <li class="breadcrumb-item active">Low Libido</li>
      </ol>
    </div>
  </section>
  <!-- End Page Heading -->
      ...
      <div class="row cs_gap_y_40">
        <div class="col-lg-6">
          <div class="cs_about_thumb">
            <img src="assets/img/treatment/4.jpg" alt="">
        ...
        <div class="col-lg-6">
          <div class="cs_about_content">
            <div class="cs_section_heading cs_style_1">
              ...
              <h2 class="cs_section_title"> Effective Solutions for Low <br>Libido Treatment</h2>
            </div>
            <p class="cs_about_text">If you're experiencing a decrease in sexual desire, you're not alone —
              low libido is a common issue, but it is treatable. At our clinic, we specialize in providing
              a safe, natural, and effective treatment plan designed to restore your libido, boost your
              confidence, and enhance overall sexual health. Our approach is customized based on your
              unique needs, ensuring the best possible results.
            </p>
            <p class="cs_about_text mt-0">Our treatment plan is all about natural, long-lasting results.
              You’ll get a customized plan that helps you feel better, regain confidence, and enjoy a
              healthier, more satisfying life.By focusing on these holistic treatments, we can help you
              restore
              your libido and improve your sexual health naturally, leading to a more satisfying and
              fulfilling life.</p>
            ...
            <div class="cs_about_btns">
              <a href="https://www.youtube.com/embed/Xvz9wG2QVzE?si=FHWgv7nhi9GLuzdq" class="cs_video_open">
