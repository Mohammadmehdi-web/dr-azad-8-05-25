...
<head>
  ...
  <!-- Site Title -->
  <title>Dr. Azad Sexologist Clinic | Erectile Dysfunction</title>
...
<body>
  ...
  <section class="cs_page_heading cs_bg_filed cs_center" data-src="assets/img/page_heading_bg.jpg">
    <div class="container">
      <h1 class="cs_page_title"> Erectile Dysfunction</h1>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href='https://sexproblemtreatment.com/'>Home</a></li>
        <li class="breadcrumb-item active"> Erectile Dysfunction</li>
      </ol>
    </div>
  </section>
  <!-- End Page Heading -->
      ...
      <div class="row cs_gap_y_40">
        <div class="col-lg-6">
          <div class="cs_about_thumb">
            <img src="assets/img/treatment/2.jpg" alt="">
        ...
        <div class="col-lg-6">
          <div class="cs_about_content">
            <div class="cs_section_heading cs_style_1">
              ...
              <h2 class="cs_section_title"> Effective & Natural <br>Recovery</h2>
            </div>
            <p class="cs_about_text">Erectile Dysfunction is a common condition where a man finds it
              difficult to achieve or maintain an erection. It can affect confidence, relationships, and
              overall well-being. The good news is — this condition is completely treatable.
            </p>
            <p class="cs_about_text mt-0">Our process starts with a personalized consultation to understand
              your lifestyle, health, and condition. Based on that, we provide carefully prepared
              medicines that help improve blood flow, strengthen nerves, and restore natural energy
              levels. These are free from side effects and are designed to work gradually but deeply.</p>
            ...
            <div class="cs_about_btns">
              <a href="https://www.youtube.com/embed/jo2fMym2kyc?si=Oj9qhxmQ93HkSZug" class="cs_video_open">
