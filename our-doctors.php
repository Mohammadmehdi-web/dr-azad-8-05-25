...
<head>
  ...
  <!-- Site Title -->
  <title>Dr. Azad Sexologist Clinic | Our-Doctors</title>
    ...
    <div class="container">
      <div class="cs_section_heading cs_style_1 text-center">
        <p class="cs_section_subtitle cs_accent_color">
          <span class="cs_shape_left"></span>OUR DOCTORS<span class="cs_shape_right"></span>
        </p>
        <h2 class="cs_section_title">Meet Our Specialist <br>Doctor</h2>
      </div>
      <div class="cs_height_50 cs_height_lg_50"></div>
      <div class="cs_doctors_grid cs_style_1">
        <div class="cs_team cs_style_1 cs_blue_bg active">
          <div class="cs_team_shape cs_accent_bg"></div>
          <a class='cs_team_thumbnail active'>
            <img src="assets/img/clinic/mo1.jpg" alt="Team Thumbnail">
          </a>
          <div class="cs_team_bio">
            <h3 class="cs_team_title cs_extra_bold mb-0 text-white">Dr. Azad
            </h3>
            <p class="cs_team_subtitle">Sexologist </p>
            <div class="cs_experience_badge">15 Years Experience</div>
          </div>
        </div>
        ...
        <div class="cs_team cs_style_1 cs_blue_bg active">
          <div class="cs_team_shape cs_accent_bg"></div>
          <a class='cs_team_thumbnail active'>
            <img src="assets/img/clinic/biwi.png" alt="Team Thumbnail">
          </a>
          <div class="cs_team_bio">
            <h3 class="cs_team_title cs_extra_bold mb-0 text-white">Dr. Shazli Azad
            </h3>
            <p class="cs_team_subtitle">Gynaecologist </p>
            <div class="cs_experience_badge">12 Years Experience</div>
          </div>
        </div>
        ...
        <div class="cs_team cs_style_1 cs_blue_bg active">
          <div class="cs_team_shape cs_accent_bg"></div>
          <a class='cs_team_thumbnail active'>
            <img src="assets/img/clinic/lo1.jpg" alt="Team Thumbnail">
          </a>
          <div class="cs_team_bio">
            <h3 class="cs_team_title cs_extra_bold mb-0 text-white">Dr. M F Khan
            </h3>
            <p class="cs_team_subtitle">Sexologist </p>
            <div class="cs_experience_badge">20 Years Experience</div>
          </div>
        </div>
        <div class="cs_team cs_style_1 cs_blue_bg active">
          <div class="cs_team_shape cs_accent_bg"></div>
          <a class='cs_team_thumbnail active'>
            <img src="assets/img/clinic/d2.jpg" alt="Team Thumbnail">
          </a>
          <div class="cs_team_bio">
            <h3 class="cs_team_title cs_extra_bold mb-0 text-white">Dr. Shivam Chauhan
            </h3>
            <p class="cs_team_subtitle">Sexologist </p>
            <div class="cs_experience_badge">6 Years Experience</div>
          </div>
        </div>
        ...
        <div class="cs_team cs_style_1 cs_blue_bg active">
          <div class="cs_team_shape cs_accent_bg"></div>
          <a class='cs_team_thumbnail active'>
            <img src="assets/img/clinic/Rawat.jpg" alt="Team Thumbnail">
          </a>
          <div class="cs_team_bio">
            <h3 class="cs_team_title cs_extra_bold mb-0 text-white">Dr. Suneel Rawat</h3>
            <p class="cs_team_subtitle">Sexologist</p>
            <div class="cs_experience_badge">8 Years Experience</div>
          </div>
        </div>
        ...
        <div class="cs_team cs_style_1 cs_blue_bg active">
          <div class="cs_team_shape cs_accent_bg"></div>
          <a class='cs_team_thumbnail active'>
            <img src="assets/img/clinic/d1.jpg" alt="Team Thumbnail">
          </a>
          <div class="cs_team_bio">
            <h3 class="cs_team_title cs_extra_bold mb-0 text-white">Dr. Keshav Manjhi
            </h3>
            <p class="cs_team_subtitle">Sexologist </p>
            <div class="cs_experience_badge">8 Years Experience</div>
          </div>
