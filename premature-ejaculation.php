...
<head>
  ...
  <!-- Site Title -->
  <title>Dr. Azad Sexologist Clinic | Premature Ejaculation</title>
...
<body>
  ...
  <section class="cs_page_heading cs_bg_filed cs_center" data-src="assets/img/page_heading_bg.jpg">
    <div class="container">
      <h1 class="cs_page_title"> Premature Ejaculation</h1>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href='https://sexproblemtreatment.com/'>Home</a></li>
        <li class="breadcrumb-item active"> Premature Ejaculation</li>
      </ol>
    </div>
  </section>
  <!-- End Page Heading -->
      ...
      <div class="row cs_gap_y_40">
        <div class="col-lg-6">
          <div class="cs_about_thumb">
            <img src="assets/img/treatment/1.jpg" alt="">
        ...
        <div class="col-lg-6">
          <div class="cs_about_content">
            <div class="cs_section_heading cs_style_1">
              ...
              <h2 class="cs_section_title"> Safe & Result-Oriented Treatment</h2>
            </div>
            <p class="cs_about_text">Premature Ejaculation (PE) is a very common issue these days. It occurs when a man
              ejaculates earlier than desired during sexual problems, which can lead to stress, embarrassment, and
              problems in relationships. But the good news is — this condition is completely treatable, and our
              treatment provides effective and long-lasting results.
            </p>
            <p class="cs_about_text mt-0">At our clinic, we treat PE using a natural and proven method that strengthens
              the
              body from within. This is not a temporary fix — our approach is designed to bring permanent and long-term
              improvement. Instead of just managing the symptoms, we focus on identifying and treating the root cause of
              the problem.</p>
            ...
            <div class="cs_about_iconbox">
              ...
              <p class="cs_about_iconbox_subtitle">You can visit our clinic or consult from the comfort of your home.
              </p>
            </div>
            <div class="cs_about_btns">
              <a href="https://www.youtube.com/embed/dRkD8jAIxVc?si=PmdTSHh5KpZW4VVm" class="cs_video_open">
                <span class="cs_player_btn cs_center">
                  <span></span>
                </span>
                <span class="cs_play_btn_text">How Our Treatment Works</span>
              </a>
              <a class='cs_btn cs_style_1' href='https://www.youtube.com/embed/dRkD8jAIxVc?si=PmdTSHh5KpZW4VVm'
                target="_blank">
