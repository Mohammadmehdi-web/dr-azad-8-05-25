...
<head>
  ...
  <!-- Site Title -->
  <title>Dr. Azad Sexologist Clinic | About-Us</title>
...
<body>
  ...
  <section class="cs_page_heading cs_bg_filed cs_center" data-src="assets/img/page_heading_bg.jpg">
    <div class="container">
      <h1 class="cs_page_title">About Us</h1>
      <ol class="breadcrumb">
        ...
        <div class="col-lg-6">
          <div class="cs_about_thumb">
            <div class="cs_about_thumb_1">
              <img src="assets/img/new/about_img_7.jpg" alt="About Image">

            </div>
            <div class="cs_about_thumb_2">
              <img src="assets/img/new/about_img_2.jpg" alt="About Image">
            ...
            <div class="row cs_gap_y_30">
              <div class="col-sm-6">
                <div class="cs_iconbox cs_style_1">
                  ...
                  <p class="cs_iconbox_subtitle mb-0 text-justify">Safe, Natural, and Effective Ayurvedic Treatments for
                    Sexual Health. Regain Confidence, Restore Happiness, and Live Fully with Ayurveda.
                  </p>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="cs_iconbox cs_style_1">
                  ...
                  <p class="cs_iconbox_subtitle mb-0 text-justify">Experience Natural Healing with Ayurveda. Safe,
                    Effective Treatments for Sexual Health Issues.</p>
                </div>
              </div>
            </div>
  ...
  <section>
    ...
    <div class="container">
      <div class="row cs_gap_y_40 align-items-center mb-5">
        <div class="col-lg-7 col-md-12 order-lg-1 order-2">
          <div class="cs_solution_content_wrapper">
            <div class="cs_section_heading cs_style_1">
              <div class="cs_section_heading_left">
                <p class="cs_section_subtitle cs_accent_color wow fadeInLeft" data-wow-duration="0.9s"
                  data-wow-delay="0.25s">
                  <span class="cs_shape_left"></span>MISSION
                </p>
                <h2 class="cs_section_title">Our Mission</h2>
              </div>
              <div class="cs_section_heading_right text-justify">
                Our mission is to help people overcome sexual health problems using natural Ayurvedic treatments. We
                provide safe and effective solutions that address the root cause of health issues. Our goal is to
                restore confidence and happiness by improving overall well-being. We are committed to offering
                personalized care and expert guidance. By combining traditional Ayurvedic knowledge with modern
                practices, we ensure our treatments are both reliable and beneficial. Our focus is to create a welcoming
                space where individuals can discuss their concerns without hesitation.
                </br>
                We strive to empower our patients through education and awareness, helping them make informed decisions
                about their health. Our dedicated team of experienced Ayurvedic practitioners works closely with each
                individual to understand their unique concerns and develop personalized treatment plans.
              </div>
            </div>
          </div>
        </div>
        <div class="col-lg-5 col-md-12 order-lg-2 order-1 mb-4 mb-lg-0">
          <div class="cs_solution_thumbnail text-center">
            <img style="object-fit:cover;" src="assets/img/new/Mission.jpg" alt="Mission Image" class="img-fluid">
          </div>
        </div>
      </div>

      <div class="row cs_gap_y_40 align-items-center mt-5">
        <div class="col-lg-5 col-md-12 mb-4 mb-lg-0">
          <div class="cs_solution_thumbnail text-center">
            <img style="object-fit:cover;" src="assets/img/new/Vision.jpg" alt="Vision Image" class="img-fluid">
          </div>
        </div>
        <div class="col-lg-7 col-md-12">
          <div class="cs_solution_content_wrapper vission">
            <div class="cs_section_heading cs_style_1">
              <div class="cs_section_heading_left">
                <p class="cs_section_subtitle cs_accent_color wow fadeInLeft" data-wow-duration="0.9s"
                  data-wow-delay="0.25s">
                  <span class="cs_shape_left"></span>VISION
                </p>
                <h2 class="cs_section_title">Our Vision</h2>
              </div>
              <div class="cs_section_heading_right text-justify">
                Our vision is to be a leading provider of Ayurvedic sexual health care. We aim to spread awareness about
                the benefits of Ayurveda and help people embrace natural healing. We believe in breaking the stigma
                around sexual health and encouraging open conversations. By promoting safe and holistic treatments, we
                want to help people achieve lasting health and happiness. Our vision is to see a world where everyone
                has access to effective Ayurvedic solutions and enjoys a confident, fulfilling life. </br>
                We aspire to create a supportive environment where individuals feel empowered to take control of their
                well-being. Through
                continuous research and collaboration with Ayurvedic experts, we are dedicated to refining our
                treatments and offering innovative solutions. Our goal is not only to provide immediate relief but also
                to promote
                long-term health benefits, fostering physical, mental, and emotional balance.
              </div>
            </div>
          </div>
        </div>
  ...
  <section class="cs_gray_bg">
    ...
    <div class="container">
      <div class="cs_section_heading cs_style_1 cs_type_1">
        <div class="cs_section_heading_left">
          <p class="cs_section_subtitle cs_accent_color wow fadeInLeft" data-wow-duration="0.9s" data-wow-delay="0.25s">
            <span class="cs_shape_left"></span> TREATMENTS
          </p>
          <h2 class="cs_section_title">We Heal Sexual Health Issues Naturally with <span
              style="color:#6c911e">Ayurveda</span></h2>
        </div>
        <div class="cs_section_heading_right text-justify">We help in treatment and cure of all the problems related to
          one’s sexual
          life. We observe the symptoms, diagnose & understand the root-causes, and advise the best remedies to our
          patients.
        </div>
      </div>
      ...
      <div class="cs_slider cs_style_1 cs_slider_gap_24">
          ...
          <div class="cs_slider_wrapper">
            <div class="cs_slide">
              <div class="cs_iconbox cs_style_7">
                <a class='cs_iconbox_thumbnail' href='https://sexproblemtreatment.com/hair-fall-treatment.php'>
                  <img src="assets/img/new/Services/Hair-Fall-Treatment.jpg" alt="Image">
                </a>
                <div class="cs_iconbox_content">
                  <div class="cs_iconbox_overlay cs_bg_filed" data-src="assets/img/new/Services/service-bg.png"></div>
                  <div class="cs_iconbox_icon cs_center">
                    <img src="assets/img/Icons-treat/Hair-Fall-Treatment.png" alt="Icon">
                  </div>
                  <h3 class="cs_iconbox_title"><a href='https://sexproblemtreatment.com/hair-fall-treatment.php'>Hair
                      Fall treatment (बाल झड़ने का इलाज)</a></h3>
                  <p class="cs_iconbox_subtitle">Hair fall treatment atDr. Azad Sexologist Clinic includes Ayurvedic
                    therapies to
                    strengthen roots, reduce hair fall, and promote scalp health.</p>
                  <a class='cs_iconbox_btn' href='https://sexproblemtreatment.com/hair-fall-treatment.php'>
                    <span>Read More</span>
                    <span><i class="fa-solid fa-angle-right"></i></span>
                  </a>
                  <div class="cs_iconbox_shape_1 position-absolute"></div>
                  <div class="cs_iconbox_shape_2 position-absolute"></div>
                </div>
              </div>
            </div>
            <div class="cs_slide">
              <div class="cs_iconbox cs_style_7">
                <a class='cs_iconbox_thumbnail' href='https://sexproblemtreatment.com/phimosis-treatment.php'>
                  <img src="assets/img/new/Services/phemosis.jpg" alt="Image">
                </a>
                <div class="cs_iconbox_content">
                  <div class="cs_iconbox_overlay cs_bg_filed" data-src="assets/img/new/Services/service-bg.png"></div>
                  <div class="cs_iconbox_icon cs_center">
                    <img src="assets/img/Icons-treat/Phimosis-Treatment.png" alt="Icon">
                  </div>
                  ...
                  <p class="cs_iconbox_subtitle">Dr. Azad Sexologist Clinic offers Ayurvedic solutions to
                    reduce discomfort, improve foreskin flexibility, and prevent infections effectively.</p>
                  <a class='cs_iconbox_btn' href='https://sexproblemtreatment.com/phimosis-treatment.php'>
                    <span>Read More</span>
                    <span><i class="fa-solid fa-angle-right"></i></span>
                  </a>
                  <div class="cs_iconbox_shape_1 position-absolute"></div>
            ...
            <div class="cs_slide">
              <div class="cs_iconbox cs_style_7">
                <a class='cs_iconbox_thumbnail' href='https://sexproblemtreatment.com/piles-treatment.php'>
                  <img src="assets/img/new/Services/Piles.jpg" alt="Image">
                </a>
                <div class="cs_iconbox_content">
                  <div class="cs_iconbox_overlay cs_bg_filed" data-src="assets/img/new/Services/service-bg.png"></div>
                  <div class="cs_iconbox_icon cs_center">
                    <img src="assets/img/Icons-treat/Piles-Treatment.png" alt="Icon">
                  </div>
                  <h3 class="cs_iconbox_title"><a href='https://sexproblemtreatment.com/piles-treatment.php'>Piles
                      Treatment (बवासीर का इलाज)</a></h3>
                  <p class="cs_iconbox_subtitle"> Dr. Azad Sexologist Clinic offers effective Ayurvedic solutions for
                    pain relief,
                    reducing swelling, and promoting healing naturally.</p>
                  <a class='cs_iconbox_btn' href='https://sexproblemtreatment.com/piles-treatment.php'>
                    <span>Read More</span>
                    <span><i class="fa-solid fa-angle-right"></i></span>
                  </a>
                  <div class="cs_iconbox_shape_1 position-absolute"></div>
            ...
            <div class="cs_slide">
              <div class="cs_iconbox cs_style_7">
                <a class='cs_iconbox_thumbnail' href='https://sexproblemtreatment.com/anxiety-and-stress.php'>
                  <img src="assets/img/new/Services/Anxiety-&-Stress.jpg" alt="Image">
                </a>
                <div class="cs_iconbox_content">
                  <div class="cs_iconbox_overlay cs_bg_filed" data-src="assets/img/new/Services/service-bg.png"></div>
                  <div class="cs_iconbox_icon cs_center">
                    <img src="assets/img/Icons-treat/Anxiety-&-Stress.png" alt="Icon">
                  </div>
                  <h3 class="cs_iconbox_title"><a href='https://sexproblemtreatment.com/anxiety-and-stress.php'>Anxiety
                      and Stress ( चिंता / तनाव)</a></h3>
                  <p class="cs_iconbox_subtitle">Manage anxiety and stress effectively with personalized Ayurvedic
                    therapies promoting mental and emotional well-being.</p>
                  <a class='cs_iconbox_btn' href='https://sexproblemtreatment.com/anxiety-and-stress.php'>
                    <span>Read More</span>
                    <span><i class="fa-solid fa-angle-right"></i></span>
                  </a>
                  <div class="cs_iconbox_shape_1 position-absolute"></div>
            ...
            <div class="cs_slide">
              <div class="cs_iconbox cs_style_7">
                <a class='cs_iconbox_thumbnail' href='https://sexproblemtreatment.com/diabetes.php'>
                  <img src="assets/img/new/Services/Diabetes.jpg" alt="Image">
                </a>
                <div class="cs_iconbox_content">
                  <div class="cs_iconbox_overlay cs_bg_filed" data-src="assets/img/new/Services/service-bg.png"></div>
                  <div class="cs_iconbox_icon cs_center">
                    <img src="assets/img/Icons-treat/Diabetes.png" alt="Icon">
                  </div>
                  <h3 class="cs_iconbox_title"><a href='https://sexproblemtreatment.com/diabetes.php'>Diabetes
                      (मधुमेह)</a></h3>
                  <p class="cs_iconbox_subtitle text-justify">Manage diabetes effectively with personalized Ayurvedic
                    treatments and
                    holistic lifestyle guidance.</p>
                  <a class='cs_iconbox_btn' href='https://sexproblemtreatment.com/diabetes.php'>
                    <span>Read More</span>
                    <span><i class="fa-solid fa-angle-right"></i></span>
                  </a>
                  <div class="cs_iconbox_shape_1 position-absolute"></div>
            ...
            <div class="cs_slide">
              <div class="cs_iconbox cs_style_7">
                <a class='cs_iconbox_thumbnail' href='https://sexproblemtreatment.com/low-sperm-count.php'>
                  <img src="assets/img/new/Services/Low-Sperm-Count.jpg" alt="Image">
                </a>
                <div class="cs_iconbox_content">
                  <div class="cs_iconbox_overlay cs_bg_filed" data-src="assets/img/new/Services/service-bg.png"></div>
                  <div class="cs_iconbox_icon cs_center">
                    <img src="assets/img/Icons-treat/Low-Sperm-Count.png" alt="Icon">
                  </div>
                  <h3 class="cs_iconbox_title"><a href='https://sexproblemtreatment.com/low-sperm-count.php'>Low sperm
                      count (शुक्राणुओं की कमी)</a></h3>
                  <p class="cs_iconbox_subtitle">Boost fertility with Ayurvedic therapies to naturally improve low sperm
                    count.</p>
                  <a class='cs_iconbox_btn' href='https://sexproblemtreatment.com/low-sperm-count.php'>
                    <span>Read More</span>
                    <span><i class="fa-solid fa-angle-right"></i></span>
                  </a>
                  <div class="cs_iconbox_shape_1 position-absolute"></div>
            ...
            <div class="cs_slide">
              <div class="cs_iconbox cs_style_7">
                <a class='cs_iconbox_thumbnail' href='https://sexproblemtreatment.com/penis-enlargement.php'>
                  <img src="assets/img/new/Services/Penis-Enlargement.jpg" alt="Image">
                </a>
                <div class="cs_iconbox_content">
                  <div class="cs_iconbox_overlay cs_bg_filed" data-src="assets/img/new/Services/service-bg.png"></div>
                  <div class="cs_iconbox_icon cs_center">
                    <img src="assets/img/Icons-treat/Penis-Enlargement.png" alt="Icon">
                  </div>
                  <h3 class="cs_iconbox_title"><a href='https://sexproblemtreatment.com/penis-enlargement.php'>Penis
                      enlargement (लिंग वृद्धि)</a></h3>
                  <p class="cs_iconbox_subtitle">Enhance confidence and satisfaction with safe, Ayurvedic penis
                    enlargement treatments.</p>
                  <a class='cs_iconbox_btn' href='https://sexproblemtreatment.com/penis-enlargement.php'>
                    <span>Read More</span>
                    <span><i class="fa-solid fa-angle-right"></i></span>
                  </a>
                  <div class="cs_iconbox_shape_1 position-absolute"></div>
            ...
            <div class="cs_slide">
              <div class="cs_iconbox cs_style_7">
                <a class='cs_iconbox_thumbnail' href='https://sexproblemtreatment.com/low-libido.php'>
                  <img src="assets/img/new/Services/Low-libido.jpg" alt="Image">
                </a>
                <div class="cs_iconbox_content">
                  <div class="cs_iconbox_overlay cs_bg_filed" data-src="assets/img/new/Services/service-bg.png"></div>
                  <div class="cs_iconbox_icon cs_center">
                    <img src="assets/img/Icons-treat/Low-Libido.png" alt="Icon">
                  </div>
                  <h3 class="cs_iconbox_title"><a href='https://sexproblemtreatment.com/low-libido.php'>Low libido
                      (कामेच्छा की कमी)</a></h3>
                  <p class="cs_iconbox_subtitle">Reignite passion and desire with Ayurvedic solutions for low libido
                    issues.</p>
                  <a class='cs_iconbox_btn' href='https://sexproblemtreatment.com/low-libido.php'>
                    <span>Read More</span>
                    <span><i class="fa-solid fa-angle-right"></i></span>
                  </a>
                  <div class="cs_iconbox_shape_1 position-absolute"></div>
            ...
            <div class="cs_slide">
              <div class="cs_iconbox cs_style_7">
                <a class='cs_iconbox_thumbnail' href='https://sexproblemtreatment.com/nightfall.php'>
                  <img src="assets/img/new/Services/Nightfall.jpg" alt="Image">
                </a>
                <div class="cs_iconbox_content">
                  <div class="cs_iconbox_overlay cs_bg_filed" data-src="assets/img/new/Services/service-bg.png"></div>
                  <div class="cs_iconbox_icon cs_center">
                    <img src="assets/img/Icons-treat/nightfall.png" alt="Icon">
                  </div>
                  <h3 class="cs_iconbox_title"><a href='https://sexproblemtreatment.com/nightfall.php'>Nightfall
                      (स्वप्नदोष)</a></h3>
                  <p class="cs_iconbox_subtitle">Nightfall involves involuntary ejaculation during sleep, treatable with
                    Ayurvedic therapies.</p>
                  <a class='cs_iconbox_btn' href='https://sexproblemtreatment.com/nightfall.php'>
                    <span>Read More</span>
                    <span><i class="fa-solid fa-angle-right"></i></span>
                  </a>
                  <div class="cs_iconbox_shape_1 position-absolute"></div>
            ...
            <div class="cs_slide">
              <div class="cs_iconbox cs_style_7">
                <a class='cs_iconbox_thumbnail' href='https://sexproblemtreatment.com/erectile-dysfunction.php'>
                  <img src="assets/img/new/Services/Erectile.jpg" alt="Image">
                </a>
                <div class="cs_iconbox_content">
                  <div class="cs_iconbox_overlay cs_bg_filed" data-src="assets/img/new/Services/service-bg.png"></div>
                  <div class="cs_iconbox_icon cs_center">
                    <img src="assets/img/Icons-treat/Erectile-Dysfunction.png" alt="Icon">
                  </div>
                  <h3 class="cs_iconbox_title"><a
                      href='https://sexproblemtreatment.com/erectile-dysfunction.php'>Erectile dysfunction
                      (नपुंसकता)</a></h3>
                  <p class="cs_iconbox_subtitle">Erectile dysfunction affects sexual performance; Ayurvedic treatments
                    restore confidence and function.</p>
                  <a class='cs_iconbox_btn' href='https://sexproblemtreatment.com/erectile-dysfunction.php'>
                    <span>Read More</span>
                    <span><i class="fa-solid fa-angle-right"></i></span>
                  </a>
                  <div class="cs_iconbox_shape_1 position-absolute"></div>
            ...
            <div class="cs_slide">
              <div class="cs_iconbox cs_style_7">
                <a class='cs_iconbox_thumbnail' href='https://sexproblemtreatment.com/premature-ejaculation.php'>
                  <img src="assets/img/new/Services/Premature.jpg" alt="Image">
                </a>
                <div class="cs_iconbox_content">
                  <div class="cs_iconbox_overlay cs_bg_filed" data-src="assets/img/new/Services/service-bg.png"></div>
                  <div class="cs_iconbox_icon cs_center">
                    <img src="assets/img/Icons-treat/Premature-Ejaculation.png" alt="Icon">
                  </div>
                  <h3 class="cs_iconbox_title"><a
                      href='https://sexproblemtreatment.com/premature-ejaculation.php'>Premature ejaculation
                      (शीघ्रपतन)</a></h3>
                  <p class="cs_iconbox_subtitle">Premature ejaculation affects satisfaction; Ayurvedic treatments offer
                    lasting control and confidence.</p>
                  <a class='cs_iconbox_btn' href='https://sexproblemtreatment.com/premature-ejaculation.php'>
                    <span>Read More</span>
                    <span><i class="fa-solid fa-angle-right"></i></span>
                  </a>
                  <div class="cs_iconbox_shape_1 position-absolute"></div>
        ...
        <div class="cs_pagination cs_style_2 cs_white_color"></div>
      </div>
    </div>
    <div class="cs_height_120 cs_height_lg_80"></div>
  </section>
