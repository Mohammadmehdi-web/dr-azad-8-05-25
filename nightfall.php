...
<head>
  ...
  <!-- Site Title -->
  <title>Dr. Azad Sexologist Clinic | Nightfall</title>
...
<body>
  ...
  <section class="cs_page_heading cs_bg_filed cs_center" data-src="assets/img/page_heading_bg.jpg">
    <div class="container">
      <h1 class="cs_page_title"> Nightfall</h1>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href='https://sexproblemtreatment.com/'>Home</a></li>
        <li class="breadcrumb-item active"> Nightfall</li>
      </ol>
    </div>
  </section>
  <!-- End Page Heading -->
      ...
      <div class="row cs_gap_y_40">
        <div class="col-lg-6">
          <div class="cs_about_thumb">
            <img src="assets/img/treatment/3.jpg" alt="">
        ...
        <div class="col-lg-6">
          <div class="cs_about_content">
            <div class="cs_section_heading cs_style_1">
              ...
              <h2 class="cs_section_title"> Trusted & Personalized <br> Treatment</h2>
            </div>
            <p class="cs_about_text">Nightfall, also known as Nocturnal Emission, is a natural process that
              can become problematic when it occurs frequently. It can lead to weakness, fatigue, lack of
              confidence, and even anxiety. But the good news is — this condition is completely treatable
              with the right approach, without any side effects or dependency.
            </p>
            <p class="cs_about_text mt-0">At our clinic, we offer a safe and effective treatment plan that
              focuses on strengthening the nerves, balancing hormones, calming the mind, and restoring
              body strength. Our doctors prepare a personalized treatment for each patient based on their
              lifestyle, body type, and symptoms. The goal is long-term recovery — not just temporary
              relief.</p>
            ...
            <div class="cs_about_btns">
              <a href="https://www.youtube.com/embed/VIcNU9PWuNA?si=UnOpxiYsuwugbwDr" class="cs_video_open">
