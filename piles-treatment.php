...
<head>
  ...
  <!-- Site Title -->
  <title>Dr. Azad Sexologist Clinic | piles-treatment</title>
...
<body>
  ...
  <section class="cs_page_heading cs_bg_filed cs_center" data-src="assets/img/page_heading_bg.jpg">
    <div class="container">
      <h1 class="cs_page_title"> Piles Treatment</h1>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href='https://sexproblemtreatment.com/'>Home</a></li>
        <li class="breadcrumb-item active"> Piles Treatment</li>
      </ol>
    </div>
  </section>
  <!-- End Page Heading -->
      ...
      <div class="row cs_gap_y_40">
        <div class="col-lg-6">
          <div class="cs_about_thumb">
            <img src="assets/img/treatment/10.jpg" alt="">
        ...
        <div class="col-lg-6">
          <div class="cs_about_content">
            <div class="cs_section_heading cs_style_1">
              ...
              <h2 class="cs_section_title">End Piles Discomfort


                <br> with <span style="color:#6c911e">Ayurvedic</span> Care
              </h2>
            </div>
            <p class="cs_about_text">Piles, also known as Hemorrhoids, is a painful condition where the veins in the
              rectum or anus become swollen and inflamed. It can cause bleeding, itching, pain, and discomfort during
              bowel movements. If left untreated, piles can worsen over time, leading to chronic pain and complications.
              The good news is that Piles is treatable with safe and effective Ayurvedic solutions!

            </p>
            <p class="cs_about_text mt-0">At Dr. Azad Sexologist Clinic, we specialize in natural and permanent
              treatment for Piles using Ayurvedic remedies, modern diagnostic techniques, and personalized therapy. Our
              approach focuses on reducing inflammation, improving digestion, and strengthening rectal veins through
            ...
            <div class="cs_about_btns">
              <a href="https://www.youtube.com/embed/OjeloYnKXB0?si=2MEi70ek4BzZ1S1t" class="cs_video_open">
