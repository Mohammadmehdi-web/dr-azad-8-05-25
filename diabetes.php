...
<head>
  ...
  <!-- Site Title -->
  <title>Dr. Azad Sexologist Clinic | diabetes</title>
...
<body>
  ...
  <section class="cs_page_heading cs_bg_filed cs_center" data-src="assets/img/page_heading_bg.jpg">
    <div class="container">
      <h1 class="cs_page_title"> Diabetes </h1>
      <ol class="breadcrumb">
      ...
      <div class="row cs_gap_y_40">
        <div class="col-lg-6">
          <div class="cs_about_thumb">
            <img src="assets/img/treatment/8.jpg" alt="">
        ...
        <div class="col-lg-6">
          <div class="cs_about_content">
            <div class="cs_section_heading cs_style_1">
              ...
              <h2 class="cs_section_title"> Control Diabetes Naturally

                <br> with <span style="color:#6c911e">Ayurvedic</span>
              </h2>
            </div>
            <p class="cs_about_text">Diabetes is a chronic condition that affects blood sugar levels and can lead to
              various health complications, including sexual dysfunction, low libido, erectile dysfunction (ED),
              premature ejaculation, and infertility. High blood sugar levels can damage nerves, blood vessels, and
              hormonal balance, impacting overall sexual and reproductive health. If you are struggling with
              diabetes-related sexual issues, don’t worry—effective treatment is available!

            </p>
            <p class="cs_about_text mt-0">At Dr. Azad Sexologist Clinic, we specialize in natural and effective diabetes
              management using Ayurvedic remedies, modern diagnostic techniques, and personalized therapy. Our treatment
              focuses on balancing blood sugar levels, improving blood circulation, and enhancing sexual wellness
              through herbal medicines, dietary modifications, and lifestyle changes.
            ...
            <div class="cs_about_btns">
              <a href="https://www.youtube.com/embed/KEmSDNw1HH8?si=r2i1qTg_jj9i2kSZ" class="cs_video_open">
